[![CircleCI](https://circleci.com/gh/zimmerman-zimmerman/Zoom.svg?style=shield&circle-token=41f4daf9d89b5f25efa5f455b6db87611527af85)](https://circleci.com/gh/zimmerman-zimmerman/Zoom)
...
- Create a file called '.env' and add these variables to it:
  ...
  ```
- run `yarn start` . And your project should run at 'http://localhost:3000' . And the express backend should be running on http://localhost:4200 , but all of the requests are proxied on the frontend when you make an express backend api call like this '/api/expressBackendCall'.

## Run with Docker

- Install Docker & docker-compose
- Go to project root folder
- Create a file called '.docker.env' and add these variables to it:
  ```
  NODE_PATH=src/app/
  REACT_APP_GRAPHQL_HOST=your_duct_api
  REACT_APP_BACKEND_HOST=your_duct_api
