/**
 * @flow
 * @relayHash 042346330df4cfdd6b149574f3902113
 */
...
fragment CountryDetailMediator_indicatorAggregations on Query {
  ...
  aidsEpidemic: datapointsAggregation(groupBy: ["indicatorName", "geolocationTag", "date", "geolocationIso2"], orderBy: ["indicatorName"], aggregation: ["Sum(value)"], geolocationIso2_In: ["undefined"], indicatorName_In: ["undefined"]) {
    indicatorName
    date
    value
  }
    ...
    "selections": [
      {
        ...
        "storageKey": "datapointsAggregation(aggregation:[\"Sum(value)\"],date_In:[\"undefined\"],groupBy:[\"indicatorName\",\"geolocationTag\",\"date\",\"geolocationIso2\"],indicatorName_In:[\"undefined\"],orderBy:[\"indicatorName\"])",
        "args": v5,
      ...
      },
      {
        ...
        "alias": "country",
        "name": "datapointsAggregation",
        "storageKey": "datapointsAggregation(aggregation:[\"Sum(value)\"],geolocationIso2_In:[\"undefined\"],groupBy:[\"indicatorName\",\"geolocationTag\",\"date\",\"geolocationIso2\"],indicatorName_In:[\"undefined\"],orderBy:[\"indicatorName\"])",
        "args": v11,
        "concreteType": "DatapointsAggregationNode",
        "plural": true,
        "selections": [
      ...
      },
      {
        ...
        "alias": "global",
        "name": "datapointsAggregation",
        "storageKey": "datapointsAggregation(aggregation:[\"Sum(value)\"],groupBy:[\"indicatorName\",\"geolocationTag\",\"date\",\"geolocationIso2\"],indicatorName_In:[\"undefined\"],orderBy:[\"indicatorName\"])",
        "args": [
          v0,
          v2,
          v3,
