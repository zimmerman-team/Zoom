...
import {
  generateLegends,
  generateMarkers
} from 'components/GeoMap/GeoMap.util';
import { MapContainer } from 'components/GeoMap/GeoMap.style';
import markerInfo from 'components/GeoMap/components/ToolTips/MarkerInfo/MarkerInfo';
import layerInfo from 'components/GeoMap/components/ToolTips/LayerInfo/LayerInfo';
...
export class DeckGlTest extends Component {
  constructor(props) {
    super(props);
...
DeckGlTest.propTypes = propTypes;
DeckGlTest.defaultProps = defaultProps;

export default withRouter(DeckGlTest);
